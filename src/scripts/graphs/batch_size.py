...
def batch_size_lat_thr(conf, results, fig_params, figPrefix="", title="", xMax=None, yMax=None, logY=False, save_fig=False, show_ci=True):
    lat_label = {
        'meanLat': "Average",
        'lat50': 'Median',
        'lat95': '95 percentile',
...
def batch_size_bars(conf, results, fig_params, figPrefix="", title="", xMax=None, yMax=None, save_fig=False):
    colors = ["#2b8cbe", "#2b8cbe", "#2b8cbe", #"#2b8cbe",
              "#cc4c02", "#cc4c02", "#cc4c02", #"#cc4c02",
              ]
