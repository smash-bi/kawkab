def get_config():
    ...
    conf['test_type'] = ['rw']
    conf['test_prefix' ] = ['kw14']
    #conf['batch_size'] = [10000]
    conf['record_size'] = [16]
    conf['batch_writeratio_rps'] = [ # list of tuples (batch_size, write_ratio, [reqs_per_second list])
                #(90, [8, 10, 11, 12, 13, 14]), #[9, 9.25, 9.5, 9.75, 10, 10.25]), #[5.2, 5.4, 5.6, 5.8]),
                #(50, [12.1, 12.5, 12.75]), #[7, 8, 9, 10, 11, 12]),
                #(10, [33, 33.5, 34, 34.5]),
                #(100, [9, 9.5, 10, 10.5, 11, 11.5]),
                # (90, [9]),
                #(100, [10]) #11, 11.25, 11.5, 10.75, 11.75, 10.5, 10, 12, 8, 7.5
                #(100, [11.5, 11, 10.5, 10, 9.5, 13, 13.5, 14, 9, 7, 5, 3]) #3, 5, 7, 9, 8, 6, 4

                #(1000, 100, [7, 7.5, 8, 8.5, 9, 8.5, 9.75, 10, 10.25, 10.5, 10.75, 11, 11.25, 11.5, 11.75]),
                #(10000, 100, [10.5, 11, 11.5, 12, 12.5, 13, 7, 9, 9.5, 10, 13.5, 14]),
                #(500, 90, [11, 11.25, 11.5, 11.75, 12, 8, 7, 6, 10, 10.5, 12.25, 13, 14]),
                #(500, 50, [11, 11.25, 11.5, 11.75, 12, 8, 10, 10.5, 12.25, 13, 14]),
                (500, 100, [9.85, 10, 10.15, 10.25, 6, 9, 9.5, 10.3, 7, 8, 10.5, 10.75, 11, 11.25, ]),
    ...
    conf['client_jvm_params'] = '-ea -Xms8g -Xmx12g -XX:+UnlockExperimentalVMOptions -XX:+UseZGC'
