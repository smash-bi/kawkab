def get_config():
    ...
    conf['test_type'] = ['rw']
    conf['test_prefix' ] = ['sep16']
    conf['batch_size'] = [500]
    conf['record_size'] = [16]
    conf['write_ratio'] = [100]
    conf['clients_per_machine'] = 20
    conf['files_per_client'] = [1]

    conf['test_duration'] = 60
    conf['warmup_sec'] = 120

    conf['iat'] = [750, 775, 825, 875, 925]
    ...
    conf['client_jvm_params'] = '-ea -Xms8g -Xmx30g -XX:+UnlockExperimentalVMOptions -XX:+UseZGC'
