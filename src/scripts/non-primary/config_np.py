def get_config():
    ...
    conf['files_per_client'] = [100]

    conf['clients_per_machine'] = 1
    conf['num_client_procs'] = [4]#[80]#[40]#[20]#[10, 15, 40, 80, 5]
    conf['num_servers'] = [1]#[4,3]#[1]#[2, 3, 4]

    conf['test_duration'] = 60
    conf['warmup_sec'] = 0
    conf['init_wait_msec'] = 100000#150000#900000
    ...
    conf['high_mps'] = 16
    conf['burst_dur_sec'] = 10
    conf['burst_prob_perc'] = 1
    conf['is_synchronous'] = "true"
    conf['read_recent'] = "false"

    conf['logGC'] = False
    conf['server_jvm_params'] = '-ea -Xms12g -Xmx18g -XX:MaxDirectMemorySize=16684m -XX:+UnlockExperimentalVMOptions -XX:+UseZGC'
