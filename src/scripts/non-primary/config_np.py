def get_config():
    ...
    conf['files_per_client'] = [80]

    conf['clients_per_machine'] = 1
    conf['num_client_procs'] = [10]#[80]#[40]#[20]#[10, 15, 40, 80, 5]
    conf['num_servers'] = [1]#[4,3]#[1]#[2, 3, 4]

    conf['test_duration'] = 300
    conf['warmup_sec'] = 0
    conf['init_wait_msec'] = 550000#150000#900000
    ...
    conf['logGC'] = False
    conf['server_jvm_params'] = '-ea -Xms12g -Xmx25g -XX:MaxDirectMemorySize=16684m -XX:+UnlockExperimentalVMOptions -XX:+UseZGC'
